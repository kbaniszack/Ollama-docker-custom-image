...
pull_if_missing() {
    ...
    if [ ! -f "$MANIFEST_PATH" ]; then
        echo "Modèle '$MODEL' non trouvé ($MANIFEST_PATH), téléchargement en cours..."
...
# Vérifier et télécharger les modèles requis
pull_if_missing "$MODEL_NAME"
pull_if_missing "$MODEL_NAME_2"
